/*ObserverTester.java and all required
classes to run the program. Make sure to follow
the Observer pattern. Note: The solution of 5.1
is available at the book publisher's web site.*/
