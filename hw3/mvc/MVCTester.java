...
2. Listeners are implemented in an anonymous
   class.
3. Model is a separate class from the client
￼￼￼￼￼￼(test) program.
4. Indication of which part of your program
      serves as model, controller or view.
   Think of the responsibilities of model, view
   and controller. I will see if the
   responsibilities are appropriately placed.*/

/*Zip 4.18 and so on to hw3.zip  DO NOT zip hw3 folder*/
